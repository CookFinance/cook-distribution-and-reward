...
describe("StakingPools", () => {
  ...
  describe("referral program", () => {
    ...
    //     await pools.connect(player).deposit(0, depositAmount, ZERO_ADDRESS);
    //     await mineBlocks(ethers.provider, 10);

    //     const rewardAmount = rewardRate * 10;

    //     expect(await pools.getAccumulatedReferralPower(await depositor.getAddress(), 0)).equal(80000);
    //     expect(await pools.getAccumulatedReferralPower(await player.getAddress(), 0)).equal(25000);
    //   });
    ...
    //     expect(await pools.getAccumulatedReferralPower(await depositor.getAddress(), 0)).equal(82500);
    //     expect(await pools.getAccumulatedReferralPower(await player.getAddress(), 0)).equal(27500);

    //     await pools.connect(depositor).withdraw(0,37500); // 85000, 30000

    //     expect(await pools.getAccumulatedReferralPower(await depositor.getAddress(), 0)).equal(85000);
    //     expect(await pools.getAccumulatedReferralPower(await player.getAddress(), 0)).equal(30000);

    //     await mineBlocks(ethers.provider, 10);

    //     expect(await pools.getAccumulatedReferralPower(await depositor.getAddress(), 0)).equal(95000);
    //     expect(await pools.getAccumulatedReferralPower(await player.getAddress(), 0)).equal(70000);
