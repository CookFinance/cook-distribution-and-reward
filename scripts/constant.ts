export const StakingPoolABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "_needVesting", type: "bool" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_poolId", type: "uint256" },
      { internalType: "uint256", name: "_referralIndex", type: "uint256" },
    ],
  ...
  },
  {
    ...
    name: "rewardVesting",
    outputs: [
      { internalType: "contract IRewardVesting", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256[]", name: "_rewardWeights", type: "uint256[]" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "_sentinel", type: "address" }],
    name: "setSentinel",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
