...
contract MockUniswapV2PairLiquidity is IUniswapV2Pair {
    ...
    function name() external override pure returns (string memory) { return "Uniswap V2"; }
    function symbol() external override pure returns (string memory) { return "UNI-V2"; }
    function decimals() external override pure returns (uint8) { return 18; }
    ...
    function price0CumulativeLast() external override view returns (uint) { revert("Should not use"); }
    function price1CumulativeLast() external override view returns (uint) { revert("Should not use"); }
